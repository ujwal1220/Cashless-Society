...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2 class="style10 style14"><span class="style4">User</span> <span class="style3"><%=request.getParameter("user")%></span><span class="style4">'s Details..</span></h2>
          <div class="clr"></div>
          <p>&nbsp;</p>
          ...
          <p align="right">&nbsp;</p>
          <p align="right"><a href="EcommerceMain.jsp" class="style11">Back</a></p>
