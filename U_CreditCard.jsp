...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
		<h2 class="style10 style14"><span class="style4">User </span><span class="style5"><%=(String)application.getAttribute("uname")%></span><span class="style4">'s Credit Card Details..</span><strong></span></strong></h2>
		</div>
	    <div class="mainbar">
          <div class="clr"></div>
          <p>&nbsp;</p>
