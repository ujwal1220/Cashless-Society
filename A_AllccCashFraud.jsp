...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2 class="style3">All Bank Fraudulent transactions</h2>
	...
	try
	{
			String sql3="select distinct activity from cash_fraud";
			...
			<p class="style13">Fraud Detection In Cash Limit </p>
	  	    <table width="572" border="1">
				  ...
				  <%
						   	...
						   	String query="select * from cash_fraud where activity='"+s11+"' "; 
	     ...
	     <%
			  ...
			  <form action="A_AllccCashFraudInChart.jsp" method="post">
