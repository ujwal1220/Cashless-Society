    ...
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          ...
          <p class="style4">&nbsp;</p>
          <p class="style4"><img src="images/Login.png" width="172" height="172" /></p>
          <div class="clr"></div>
		...
		<tr>
            ...
            <div align="center"><span class="style34 style5"><strong>Select Bank (required)</strong></span></div>
            </label></td>
            <td><p align="left">
                <select name="bank">
          ...
          <tr>
            <td height="46" align="center" valign="middle"><span class="style35">
              ...
              <label for="label">
              <div align="center"><span class="style35 style5"><strong>User Name (required)</strong></span></div>
              </label>
              <span class="style35">
          ...
          <tr>
            <td height="40" align="center" valign="middle"><span class="style35">
              ...
              <div align="center"><span class="style35 style5"><strong>Password (required)</strong></span></div>
          ...
          <tr>
            ...
            <td><input name="imageField" type="submit"  class="LOGIN" id="imageField" value="Login" />
              <span class="style38 style5">New User?</span><span class="style10"><strong><a href="UserRegister.jsp" class="style30"> Register </a></strong></span></td>
          </tr>
		  <tr>
            <td height="49"></td>
