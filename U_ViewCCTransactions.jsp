...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
		<h2 class="style10 style14"><span class="style4">User </span><span class="style5"><%=(String)application.getAttribute("uname")%></span><span class="style4">'s Credit Card Transaction Details..</span><strong></span></strong></h2>
		</div>
	    <div class="mainbar">
          <div class="clr"></div>
          <p>&nbsp;</p>
          ...
          <table width="900" border="1" align="center"  cellpadding="0" cellspacing="0"  ">
            <tr>
              <td  width="52"  valign="middle" height="34" style="color: #2c83b0;"><div align="center" class="style7 style57 style56"><strong>ID</strong></div></td>
			...
			<td align="center"  valign="middle"><div align="center" class="style9">		
			  ...
			  if(s2.equalsIgnoreCase("transfer"))
				...
				%>
					...
					<p><a href="U_MoneyTransferDetails.jsp?id=<%=i%>&ccno=<%=s1%>" class="style55">Transfer</a></p>
          ...
          <table width="476" border="0" cellspacing="2" cellpadding="2">
            <tr>
              <td width="468"><div align="right"><a href="UserMain.jsp" class="style95">Back</a></div></td>
            </tr>
          </table>
          <h2>&nbsp;</h2>
        </div>
