...
<div class="main">
  <div class="header">
    <div class="header_resize">
      <div class="logo">
        <h1 class="style1"><a href="index.html" class="style1"> Random Forest for Credit Card Fraud Detection</a></h1>
      </div>
      <div class="menu_nav">
        <ul>
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2 class="style3"> <span class="style7"><%=(String)application.getAttribute("adbank")%></span> Fraud Detection in Random Tree Based  Random Forest</h2>
...
out.println(e.getMessage());
  ...
  <div class="fbg">
    <div class="fbg_resize">
      <div class="clr style2">Random Forest for Credit Card Fraud Detection</div>
    </div>
  </div>
  <div class="footer">
