...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2 class="style3">All Normal And Abnormal CC Users in Chart..</h2>
          ...
          <div class="clr"></div>
              ...
              <iframe width="550" height="400" src="A_AllccCashFraudInChart1.jsp"></iframe>
			  				<br/>
			  				<span class="style3">(All Normal Credit Card Users for Cash Limit)							</span>
			  				<p>&nbsp;</p>
							
						
			  <iframe width="550" height="400" src="A_AllccCashFraudInChart2.jsp"></iframe>
			  				<br/>
			  				<span class="style3">(All AbNormal Credit Card Users for Cash Limit)</span>
		  <p>&nbsp;</p>
