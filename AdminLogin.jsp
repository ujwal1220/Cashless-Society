...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2 class="style3">Welcome To Bank Admin Login..</h2>
          <p class="style3">&nbsp;</p>
          <p class="style3"><img src="images/Login.png" width="172" height="172" /></p>
          <div class="clr"></div>
		...
		<tr>
            ...
            <div align="center"><span class="style4"><strong>Select Bank (required)</strong></span></div>
            </label></td>
            <td><p align="left">
                <select name="bank">
          ...
          <tr>
            <td height="46" align="center" valign="middle"><span class="style4">
              <label for="label">              </label>
              </span>
              <label for="label">
              <div align="center"><span class="style4"><strong>Bank Admin Name (required)</strong></span></div>
              </label>
              <span class="style35">
                <label for="name"></label>
              </span></td><td width="371"><input id="name" name="adminid" class="text" /></td>
          </tr>
          <tr>
            <td height="40" align="center" valign="middle"><span class="style35">
              <label for="email">              </label>
              </span>            <label for="email">
              <div align="center"><span class="style4"><strong>Password (required)</strong></span></div>
          ...
          <tr>
            ...
            <td><input name="imageField" type="submit"  class="LOGIN" id="imageField" value="Login" />
              <span class="style4">New Bank Admin?</span><span class="style38"></span><span class="style10"><a href="AdminRegister.jsp" class="style30"> <strong>Register</strong> </a></span></td>
          </tr>
		  <tr>
            <td height="49"></td>
