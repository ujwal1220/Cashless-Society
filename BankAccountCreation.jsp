...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
		<h2 class="style10 style14"><span class="style4">User</span> <span class="style3"><%=(String)application.getAttribute("uname")%></span><span class="style4">'s Bank Account Creation..</span></h2>
          <div class="clr"></div>
          <p>&nbsp;</p>
		<%
					...
					%>
            <form action="BankAccountAuthentication.jsp" method="post" id="" enctype="multipart/form-data">
