...
<head>
<title>All No Cash Fraud Users</title>
...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2 class="style3">All Normal and Abnormal CC Users For No Cash To Pay Transactions</h2>
	...
	try
	{
			String sql3="select distinct activity from payment_fraud";
			...
			%>
	  	    ...
	  	    <table width="572" border="1">
				  ...
				  <%
						   	...
						   	String query="select * from payment_fraud where activity='"+s11+"' "; 
	     ...
	     <%
			  ...
			  <form action="A_AllccNoCashFraudInChart.jsp" method="post">
