...
<head>
<title>No Cash Purchase Transactions</title>
...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2 class="style3">All Normal and Abnormal Users For No Cash For Purchase Transactions</h2>
	...
	try
	{
			...
			%>
	  	    ...
	  	    <table width="572" border="1">
				  <tr bgcolor="#FFFFFF">
					...
					<td  width="104" valign="middle" height="34" style="color: #2c83b0;"><div align="center" class="style10">Ecommerce Site</div></td>
				  ...
				  <%
						   	...
						   	String query="select * from purchase_fraud where activity='"+s11+"' "; 
	     ...
	     <%
			  ...
			  <form action="A_AllccPurchaseFraudInChart.jsp" method="post">
